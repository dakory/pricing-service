...
React.createElement('div',{style:{display:'flex',alignItems:'center',gap:8,border:'1px solid '+(error?'var(--status-danger)':focus?'var(--focus-ring)':'var(--border-default)'),borderRadius:'var(--radius-full)',padding:'11px 20px',background:'var(--surface-card)',transition:'border-color var(--duration-fast) var(--ease-standard)'}},
